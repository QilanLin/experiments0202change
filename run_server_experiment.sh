...
EXPERIMENTS_RUN_MODULE="${EXPERIMENTS_RUN_MODULE:-experiments0202change.run_experiment}"
...
echo "[INFO] Run module: ${EXPERIMENTS_RUN_MODULE}"
...
exec "${PYTHON_BIN}" -m "${EXPERIMENTS_RUN_MODULE}" "$@"
